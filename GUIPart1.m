...
%    y = eval(equation);
 %   func = strcat('@(x)',equation);
    ...
    case 'All Methods'
		...
		fixedParameter1 = get(handles.aFPXIniBox,'String');
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         
        disp('Fixed Point:');
        try
		[root3, flag, time, iterations, errs] = fixed( func ,str2double(fixedParameter1),str2double(itr),str2double(eps) ,1,handles);
